  ...
  const summaryCards = [
    {
      ...
      value: formatCurrency(summary?.total_landed_amount),
      icon: TrendingUp,
      iconBg: 'bg-emerald-100',
      iconColor: 'text-emerald-600',
      description: 'Total money lent out'
    },
    {
      title: 'Total Received Amount',
      value: formatCurrency(summary?.total_received_amount),
      icon: TrendingDown,
      iconBg: 'bg-blue-100',
    ...
    },
    {
      ...
      value: formatCurrency(summary?.total_pending_interest),
      icon: Clock,
      iconBg: 'bg-red-100',
      iconColor: 'text-red-600',
      description: 'Interest to be collected'
    }
  ];
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                <div>
                  ...
                  <p className="text-2xl font-bold font-mono text-slate-700">
                    {formatNumber(stats?.closed_accounts)}
                  </p>
                </div>
                <div className="p-3 bg-slate-200 rounded-full">
          ...
          <div className="relative h-full min-h-[300px]">
            ...
            <div className="relative z-10 p-8 flex flex-col justify-center h-full">
              ...
              <p className="text-slate-300 max-w-md">
                Track all your jewellery-backed loans with precise interest calculations 
                and comprehensive ledger management.
              </p>
              <Link
                to="/accounts"
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link
              to="/accounts/new"
              className="flex flex-col items-center gap-3 p-6 bg-emerald-50 rounded-xl hover:bg-emerald-100 transition-colors group"
            >
            ...
            <Link
              to="/accounts"
              className="flex flex-col items-center gap-3 p-6 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors group"
            >
            ...
            <Link
              to="/users"
              className="flex flex-col items-center gap-3 p-6 bg-amber-50 rounded-xl hover:bg-amber-100 transition-colors group"
            >
            ...
            <Link
              to="/accounts"
              className="flex flex-col items-center gap-3 p-6 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors group"
            >
